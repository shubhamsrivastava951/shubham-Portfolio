...
const Header = () => {
    ...
    return (
        <div>
            ...
            <img id="not-dark" onClick={scrollTo} alt="Contact Me" title="Contact Me" className="gtp" src="https://github.com/shubhamsrivastava951/shubham/blob/master/src/styles/Single.png"></img>
        </div>
    )
